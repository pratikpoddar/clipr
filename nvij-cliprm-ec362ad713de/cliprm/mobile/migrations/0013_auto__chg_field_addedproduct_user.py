...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'addedProduct', u'userid', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mobile.CliprUser'], to_field=u'userid', null=True, db_column=u'userid'))
