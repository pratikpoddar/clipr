...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Addedproduct.userid'
        db.delete_column(u'addedProduct', 'userid_id')

        # Adding field 'Addedproduct.user'
        db.add_column(u'addedProduct', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mobile.CliprUser'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Addedproduct.userid'
        db.add_column(u'addedProduct', 'userid',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mobile.CliprUser'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Addedproduct.user'
        db.delete_column(u'addedProduct', 'user_id')
    ...
    models = {
        ...
        u'mobile.addedproduct': {
            ...
            'time': ('django.db.models.fields.DateTimeField', [], {}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mobile.CliprUser']", 'null': 'True', 'blank': 'True'})
        },
