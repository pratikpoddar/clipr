...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Tagtable.userid'
        db.delete_column(u'tagTable', 'userid')

        # Deleting field 'Tagtable.productid'
        db.delete_column(u'tagTable', 'productid')

        # Deleting field 'Tagtable.taggeduser'
        db.delete_column(u'tagTable', 'taggeduser')

        # Adding field 'Tagtable.user'
        db.add_column(u'tagTable', 'user',
                      self.gf('django.db.models.fields.BigIntegerField')(null=True, db_column=u'userid', blank=True),
                      keep_default=False)

        # Adding field 'Tagtable.product'
        db.add_column(u'tagTable', 'product',
                      self.gf('django.db.models.fields.IntegerField')(default=0, db_column=u'productid'),
                      keep_default=False)

        # Adding field 'Tagtable.taggeduserid'
        db.add_column(u'tagTable', 'taggeduserid',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0, db_column=u'taggeduser'),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Tagtable.userid'
        db.add_column(u'tagTable', 'userid',
                      self.gf('django.db.models.fields.BigIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Tagtable.productid'
        db.add_column(u'tagTable', 'productid',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Tagtable.taggeduser'
        db.add_column(u'tagTable', 'taggeduser',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Tagtable.user'
        db.delete_column(u'tagTable', u'userid')

        # Deleting field 'Tagtable.product'
        db.delete_column(u'tagTable', u'productid')

        # Deleting field 'Tagtable.taggeduserid'
        db.delete_column(u'tagTable', u'taggeduser')
    ...
    models = {
        ...
        u'mobile.tagtable': {
            ...
            'id': ('django.db.models.fields.IntegerField', [], {'primary_key': 'True'}),
            'product': ('django.db.models.fields.IntegerField', [], {'db_column': "u'productid'"}),
            'taggeduserid': ('django.db.models.fields.BigIntegerField', [], {'db_column': "u'taggeduser'"}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {}),
            'user': ('django.db.models.fields.BigIntegerField', [], {'null': 'True', 'db_column': "u'userid'", 'blank': 'True'})
        },
        u'mobile.topdrops': {
