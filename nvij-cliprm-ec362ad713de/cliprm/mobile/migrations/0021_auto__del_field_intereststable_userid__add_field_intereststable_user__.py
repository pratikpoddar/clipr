...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'interestsTable', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'interest_uid', db_column=u'userid', to_field=u'userid', to=orm['mobile.CliprUser'], blank=True, null=True),
                      keep_default=False)


        # Renaming column for 'Intereststable.interest' to match new field type.
        db.rename_column(u'interestsTable', 'interest_id', u'interest')
        # Changing field 'Intereststable.interest'
        db.alter_column(u'interestsTable', u'interest', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mobile.Alltags'], db_column=u'interest'))
    ...
    def backwards(self, orm):
        ...
        # Renaming column for 'Intereststable.interest' to match new field type.
        db.rename_column(u'interestsTable', u'interest', 'interest_id')
        # Changing field 'Intereststable.interest'
        db.alter_column(u'interestsTable', 'interest_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mobile.Alltags']))
    ...
    models = {
        ...
        u'mobile.intereststable': {
            ...
            'id': ('django.db.models.fields.IntegerField', [], {'primary_key': 'True'}),
            'interest': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mobile.Alltags']", 'db_column': "u'interest'"}),
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'interest_uid'", 'db_column': "u'userid'", 'to_field': "u'userid'", 'to': u"orm['mobile.CliprUser']", 'blank': 'True', 'null': 'True'})
        },
