...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CliprUser.email'
        db.alter_column(u'fbdata', 'email', self.gf('django.db.models.fields.CharField')(max_length=100L))

    def backwards(self, orm):

        # Changing field 'CliprUser.email'
        db.alter_column(u'fbdata', 'email', self.gf('django.db.models.fields.CharField')(max_length=50L))
    ...
    models = {
        ...
        u'mobile.clipruser': {
            ...
            'email': ('django.db.models.fields.CharField', [], {'max_length': '100L'}),
