...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Tagtable.product'
        db.alter_column(u'tagTable', u'productid', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mobile.Productdetail'], null=True, db_column=u'productid'))
        # Adding index on 'Tagtable', fields ['product']
        db.create_index(u'tagTable', [u'productid'])


    def backwards(self, orm):
        # Removing index on 'Tagtable', fields ['product']
        db.delete_index(u'tagTable', [u'productid'])


        # Changing field 'Tagtable.product'
        db.alter_column(u'tagTable', u'productid', self.gf('django.db.models.fields.IntegerField')(default=0, db_column=u'productid'))
