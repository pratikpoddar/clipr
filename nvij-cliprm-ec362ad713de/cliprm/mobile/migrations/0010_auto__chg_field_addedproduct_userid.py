...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Addedproduct.userid' to match new field type.
        db.rename_column(u'addedProduct', 'userid', 'userid_id')
        # Changing field 'Addedproduct.userid'
        db.alter_column(u'addedProduct', 'userid_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mobile.CliprUser'], null=True))
        # Adding index on 'Addedproduct', fields ['userid']
        db.create_index(u'addedProduct', ['userid_id'])


    def backwards(self, orm):
        # Removing index on 'Addedproduct', fields ['userid']
        db.delete_index(u'addedProduct', ['userid_id'])


        # Renaming column for 'Addedproduct.userid' to match new field type.
        db.rename_column(u'addedProduct', 'userid_id', 'userid')
        # Changing field 'Addedproduct.userid'
        db.alter_column(u'addedProduct', 'userid', self.gf('django.db.models.fields.BigIntegerField')(null=True))
    ...
    models = {
        ...
        u'mobile.addedproduct': {
            ...
            'time': ('django.db.models.fields.DateTimeField', [], {}),
            'userid': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mobile.CliprUser']", 'null': 'True', 'blank': 'True'})
        },
