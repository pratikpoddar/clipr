...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_column(u'interestsTable', 'interest', 'interest_id')
        ...
        # Adding index on 'Intereststable', fields ['interest']
        db.create_index(u'interestsTable', ['interest_id'])


    def backwards(self, orm):
        # Removing index on 'Intereststable', fields ['interest']
        db.delete_index(u'interestsTable', ['interest_id'])


        # Renaming column for 'Intereststable.interest' to match new field type.
        db.rename_column(u'interestsTable', 'interest_id', 'interest')
        # Changing field 'Intereststable.interest'
        db.alter_column(u'interestsTable', 'interest', self.gf('django.db.models.fields.IntegerField')())
