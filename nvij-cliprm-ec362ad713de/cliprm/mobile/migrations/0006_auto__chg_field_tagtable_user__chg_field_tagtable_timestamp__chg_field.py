...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Tagtable.user'
        db.alter_column(u'tagTable', u'userid', self.gf('django.db.models.fields.related.ForeignKey')(db_column=u'userid', to_field=u'userid', to=orm['mobile.CliprUser'], null=True))
        # Adding index on 'Tagtable', fields ['user']
        db.create_index(u'tagTable', [u'userid'])


        # Changing field 'Tagtable.timestamp'
        db.alter_column(u'tagTable', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Tagtable.taggeduserid'
        db.alter_column(u'tagTable', u'taggeduser', self.gf('django.db.models.fields.related.ForeignKey')(db_column=u'taggeduser', to_field=u'userid', to=orm['mobile.CliprUser'], null=True))
        # Adding index on 'Tagtable', fields ['taggeduserid']
        db.create_index(u'tagTable', [u'taggeduser'])


    def backwards(self, orm):
        # Removing index on 'Tagtable', fields ['taggeduserid']
        db.delete_index(u'tagTable', [u'taggeduser'])

        # Removing index on 'Tagtable', fields ['user']
        db.delete_index(u'tagTable', [u'userid'])


        # Changing field 'Tagtable.user'
        db.alter_column(u'tagTable', u'userid', self.gf('django.db.models.fields.BigIntegerField')(null=True, db_column=u'userid'))

        # Changing field 'Tagtable.timestamp'
        db.alter_column(u'tagTable', 'timestamp', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Tagtable.taggeduserid'
        db.alter_column(u'tagTable', u'taggeduser', self.gf('django.db.models.fields.BigIntegerField')(default=0, db_column=u'taggeduser'))
