...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Addedproduct.user' to match new field type.
        db.rename_column(u'addedProduct', 'user_id', u'userid')
        # Changing field 'Addedproduct.user'
        db.alter_column(u'addedProduct', u'userid', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mobile.CliprUser'], null=True, db_column=u'userid'))

    def backwards(self, orm):

        # Renaming column for 'Addedproduct.user' to match new field type.
        db.rename_column(u'addedProduct', u'userid', 'user_id')
        # Changing field 'Addedproduct.user'
        db.alter_column(u'addedProduct', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mobile.CliprUser'], null=True))
    ...
    models = {
        ...
        u'mobile.addedproduct': {
            ...
            'time': ('django.db.models.fields.DateTimeField', [], {}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mobile.CliprUser']", 'null': 'True', 'db_column': "u'userid'", 'blank': 'True'})
        },
