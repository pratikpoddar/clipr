...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Producttopsimilar.similar'
        db.alter_column(u'productTopSimilar', u'similar', self.gf('django.db.models.fields.related.ForeignKey')(null=True, db_column=u'similar', to=orm['mobile.Productdetail']))
        # Adding index on 'Producttopsimilar', fields ['similar']
        db.create_index(u'productTopSimilar', [u'similar'])


    def backwards(self, orm):
        # Removing index on 'Producttopsimilar', fields ['similar']
        db.delete_index(u'productTopSimilar', [u'similar'])


        # Changing field 'Producttopsimilar.similar'
        db.alter_column(u'productTopSimilar', 'similar', self.gf('django.db.models.fields.IntegerField')(null=True))
