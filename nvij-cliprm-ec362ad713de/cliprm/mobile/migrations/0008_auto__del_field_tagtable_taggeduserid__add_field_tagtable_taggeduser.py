...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'tagTable', 'taggeduser',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'tagtable_friendid', db_column=u'taggeduser', to_field=u'userid', to=orm['mobile.CliprUser'], blank=True, null=True),
                      keep_default=False)
