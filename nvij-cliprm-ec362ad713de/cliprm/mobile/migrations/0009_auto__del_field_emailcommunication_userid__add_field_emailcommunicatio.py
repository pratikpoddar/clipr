...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Emailcommunication.userid'
        db.delete_column(u'emailCommunication', u'userid')

        # Adding field 'Emailcommunication.user'
        db.add_column(u'emailCommunication', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['mobile.CliprUser'], to_field=u'userid', primary_key=True, db_column=u'userid'),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Emailcommunication.userid'
        db.add_column(u'emailCommunication', 'userid',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['mobile.CliprUser'], to_field=u'userid', primary_key=True, db_column=u'userid'),
                      keep_default=False)

        # Deleting field 'Emailcommunication.user'
        db.delete_column(u'emailCommunication', u'userid')
