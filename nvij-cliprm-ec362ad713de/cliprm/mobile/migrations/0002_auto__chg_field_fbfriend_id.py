...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Fbfriend.id'
        db.alter_column(u'fbfriend', u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

    def backwards(self, orm):

        # Changing field 'Fbfriend.id'
        db.alter_column(u'fbfriend', 'id', self.gf('django.db.models.fields.IntegerField')(primary_key=True))
