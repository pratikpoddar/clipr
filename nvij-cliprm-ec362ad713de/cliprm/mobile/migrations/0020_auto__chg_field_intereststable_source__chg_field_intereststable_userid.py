...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'interestsTable', u'source', self.gf('django.db.models.fields.related.ForeignKey')(db_column=u'source', to_field=u'userid', to=orm['mobile.CliprUser'], null=True))
        # Adding index on 'Intereststable', fields ['source']
        db.create_index(u'interestsTable', [u'source'])


        # Changing field 'Intereststable.userid'
        db.alter_column(u'interestsTable', u'userid', self.gf('django.db.models.fields.related.ForeignKey')(db_column=u'userid', to_field=u'userid', to=orm['mobile.CliprUser'], null=True))
        # Adding index on 'Intereststable', fields ['userid']
        db.create_index(u'interestsTable', [u'userid'])


    def backwards(self, orm):
        # Removing index on 'Intereststable', fields ['userid']
        db.delete_index(u'interestsTable', [u'userid'])

        # Removing index on 'Intereststable', fields ['source']
        db.delete_index(u'interestsTable', [u'source'])


        # Changing field 'Intereststable.source'
        db.alter_column(u'interestsTable', 'source', self.gf('django.db.models.fields.BigIntegerField')(default=0))

        # Changing field 'Intereststable.userid'
        db.alter_column(u'interestsTable', 'userid', self.gf('django.db.models.fields.BigIntegerField')(null=True))
    ...
    models = {
        ...
        u'mobile.intereststable': {
            ...
            'source': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'interest_sid'", 'db_column': "u'source'", 'to_field': "u'userid'", 'to': u"orm['mobile.CliprUser']", 'blank': 'True', 'null': 'True'}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'userid': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'interest_uid'", 'db_column': "u'userid'", 'to_field': "u'userid'", 'to': u"orm['mobile.CliprUser']", 'blank': 'True', 'null': 'True'})
        },
