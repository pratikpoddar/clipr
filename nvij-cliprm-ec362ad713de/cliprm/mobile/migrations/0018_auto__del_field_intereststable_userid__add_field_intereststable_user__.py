...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Intereststable.userid'
        db.delete_column(u'interestsTable', 'userid')

        # Adding field 'Intereststable.user'
        db.add_column(u'interestsTable', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'user_uid', db_column=u'userid', to_field=u'userid', to=orm['mobile.CliprUser'], blank=True, null=True),
                      keep_default=False)


        # Renaming column for 'Intereststable.source' to match new field type.
        db.rename_column(u'interestsTable', 'source', 'source_id')
        # Changing field 'Intereststable.source'
        db.alter_column(u'interestsTable', 'source_id', self.gf('django.db.models.fields.related.ForeignKey')(to_field=u'userid', to=orm['mobile.CliprUser']))
        # Adding index on 'Intereststable', fields ['source']
        db.create_index(u'interestsTable', ['source_id'])


    def backwards(self, orm):
        # Removing index on 'Intereststable', fields ['source']
        db.delete_index(u'interestsTable', ['source_id'])

        # Adding field 'Intereststable.userid'
        db.add_column(u'interestsTable', 'userid',
                      self.gf('django.db.models.fields.BigIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Intereststable.user'
        db.delete_column(u'interestsTable', u'userid')


        # Renaming column for 'Intereststable.source' to match new field type.
        db.rename_column(u'interestsTable', 'source_id', 'source')
        # Changing field 'Intereststable.source'
        db.alter_column(u'interestsTable', 'source', self.gf('django.db.models.fields.BigIntegerField')())
    ...
    models = {
        ...
        u'mobile.emailcommunication': {
            ...
            'emailbulk': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'emaildeal': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'emailgift': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'fbactivitypost': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'fbstreampost': ('django.db.models.fields.IntegerField', [], {'default': '-1'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mobile.CliprUser']", 'to_field': "u'userid'", 'primary_key': 'True', 'db_column': "u'userid'"})
        },
        u'mobile.fbfriend': {
        ...
        u'mobile.intereststable': {
            ...
            'id': ('django.db.models.fields.IntegerField', [], {'primary_key': 'True'}),
            'interest': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mobile.Alltags']"}),
            'source': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'sourc_uid'", 'to_field': "u'userid'", 'blank': 'True', 'to': u"orm['mobile.CliprUser']"}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'user_uid'", 'db_column': "u'userid'", 'to_field': "u'userid'", 'to': u"orm['mobile.CliprUser']", 'blank': 'True', 'null': 'True'})
        },
        ...
        u'mobile.tagtable': {
            ...
            'id': ('django.db.models.fields.IntegerField', [], {'primary_key': 'True'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mobile.Productdetail']", 'null': 'True', 'db_column': "u'productid'", 'blank': 'True'}),
            'taggeduser': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'tagtable_friendid'", 'db_column': "u'taggeduser'", 'to_field': "u'userid'", 'to': u"orm['mobile.CliprUser']", 'blank': 'True', 'null': 'True'}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
