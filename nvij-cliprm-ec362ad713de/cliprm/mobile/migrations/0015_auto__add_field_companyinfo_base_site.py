...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Companyinfo.base_site'
        db.add_column(u'companyinfo', 'base_site',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200L, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Companyinfo.base_site'
        db.delete_column(u'companyinfo', 'base_site')
    ...
    models = {
        ...
        u'mobile.companyinfo': {
            ...
            'base_site': ('django.db.models.fields.URLField', [], {'max_length': '200L', 'blank': 'True'}),
            'id': ('django.db.models.fields.IntegerField', [], {'primary_key': 'True'}),
